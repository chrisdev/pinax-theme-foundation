...
In This Version
--------------------
We've added a number of  & bug fixes major feature requests for this release including:
 ...
 * Modals dialogs now work with forms where the link and the from are on different pages.
